  ...
  <div class="space-y-6 p-6">
    ...
    <div class="bg-gradient-to-r from-gray-800 to-gray-700 rounded-2xl p-6 border border-gray-600 shadow-lg">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center justify-between">
          <div>
            <label class="text-white font-medium">Dark Mode</label>
            <p class="text-gray-400 text-sm mt-1">Enable dark theme for the application</p>
          </div>
          <div class="relative inline-block w-14 h-8 bg-gray-600 rounded-full cursor-pointer" @click="toggleDarkMode">
            <div
        ...
        <div class="flex items-center justify-between pt-4 border-t border-gray-600">
          <div>
            <label class="text-white font-medium">Auto-play</label>
            <p class="text-gray-400 text-sm mt-1">Automatically start playing when opening app</p>
          </div>
    ...
    <div class="bg-gradient-to-r from-gray-800 to-gray-700 rounded-2xl p-6 border border-gray-600 shadow-lg">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between">
          <div>
            <label class="text-white font-medium">Disliked Artists</label>
            <p class="text-gray-400 text-sm mt-1">You have {{ radioStore.dislikes.length }} disliked artists saved</p>
          </div>
          <button
            @click="clearDisliked"
    ...
    <div class="bg-gradient-to-r from-gray-800 to-gray-700 rounded-2xl p-6 border border-gray-600 shadow-lg">
      ...
      <div class="space-y-4">
        <div>
          <p class="text-gray-400 text-sm">Application Name</p>
          <p class="text-white font-medium">Belgian Radio Player</p>
        </div>
        <div>
          <p class="text-gray-400 text-sm">Version</p>
          <p class="text-white font-medium">1.0.0</p>
        </div>
        <div>
          <p class="text-gray-400 text-sm">Built with</p>
          <p class="text-white font-medium">Vue.js 3 • Vue Router • Pinia • Tailwind CSS • Heroicons</p>
        </div>
    ...
    <div class="bg-gradient-to-r from-gray-800 to-gray-700 rounded-2xl p-6 border border-gray-600 shadow-lg">
      ...
      <div class="space-y-4">
        <div>
          <p class="text-white font-medium text-sm">v1.0.0 - Complete Rebuild</p>
          <ul class="text-gray-400 text-sm mt-2 space-y-1 list-disc list-inside">
            ...
            <li>Modern dark theme with gradient accents</li>
          </ul>
        </div>
      </div>
    </div>
